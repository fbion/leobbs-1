...
if ($tablewidth > 100) {
    if ($tablewidth > 1000) {$topictitlemax = 85;}
    elsif ($tablewidth > 770) {$topictitlemax = 70;}
    else {$topictitlemax = 40;}
}
else {
    if ($screenmode >= 10) {$topictitlemax = 85;}
    elsif ($screenmode >= 8) {$topictitlemax = 70;}
    else {$topictitlemax = 40;}
}
