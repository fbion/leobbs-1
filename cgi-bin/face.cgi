...
$adminbar = qq~ <img src=$imagesurl/images/fg.gif width=1 height=10> [<a href=setface.cgi>后台管理</a>]~ if (($member_code eq "ad") || ($admin_user eq $tempmembername));
